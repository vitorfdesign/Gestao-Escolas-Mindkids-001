...
const initialSchools: Record<string, School> = {
  'algodao-doce': {
    ...
    minima: {
      maternalBaby: { turmas: 2, alunos: 4 },
      maternalI: { turmas: 2, alunos: 19 },
      maternalII: { turmas: 2, alunos: 26 },
      infantilI: { turmas: 3, alunos: 42 },
      infantilII: { turmas: 3, alunos: 38 },
  ...
  'colegio-objetivo': {
    ...
    dataLimite: '2026-12-05',
    minima: {
      maternalBaby: { alunos: 8, turmas: 1 },
      maternalI: { alunos: 12, turmas: 1 },
      maternalII: { alunos: 15, turmas: 1 },
      infantilI: { alunos: 15, turmas: 1 },
      infantilII: { alunos: 15, turmas: 1 },
  ...
  'colegio-mindful': {
    ...
    minima: {
      ...
      infantilI: { alunos: 10, turmas: 1 },
      infantilII: { alunos: 10, turmas: 1 },
    ...
    confirmed: {
      maternalBaby: { alunos: 7, turmas: 1 },
      maternalI: { alunos: 10, turmas: 2 },
      maternalII: { alunos: 12, turmas: 1 },
      infantilI: { alunos: 14, turmas: 2 },
      infantilII: { alunos: 14, turmas: 2 },
